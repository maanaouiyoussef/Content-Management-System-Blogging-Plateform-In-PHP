       ...
       <table class="table table-bordered table-hover">
            ...
            <div class="col-xs-4">
                ...
                <a href="posts.php?source=add_post" class="btn btn-primary">Add New</a>
                    ...
                    <tbody>
                       <?php
                        $query_select_post = "SELECT * FROM posts ORDER BY post_id DESC  ";
           ...
           while($row = mysqli_fetch_assoc($result_cate))//$row = $sql->fetchALL(PDO::FETCH_ALL);rowCount();  
           {
                  ...
                  $cat_title = $row['cat_title'];
                            ...
                            echo "<td><a href='posts.php?source=comment_post&post_comment={$post_Id}'>{$post_comments_count}</a></td>";
                            echo "<td>{$post_date}</td>";
                            echo "<td><a href='posts.php?source=edit_post&edit={$post_Id}' class='btn btn-info'>Edit</a></td>";
                            echo "<td><a class='btn btn-danger' onClick=\"javascript: return confirm('Are you sure want to delete this post ?');\" href='posts.php?delete={$post_Id}'>Delete</a></td>";
                            echo "<td><i class='fa fa-eye'></i> {$post_views}</td>";
                            echo "</tr>";
          
                        }
                        //DELETE THE POST IF WE WANT 
